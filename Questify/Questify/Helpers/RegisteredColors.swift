...
struct RegisteredColors {
    ...
    static let grayLight = UIColor(hexString: "#DDDDDD")
    static let grayMidle = UIColor(hexString: "#AAAAAA")
    
    static let darkSky = UIColor(hexString: "#020033")
    static let deepSky = UIColor(hexString: "#3FA4A8")
    
    static let magentaSky = UIColor(hexString: "#8B2082")
    static let lightSky = UIColor(hexString: "#7BBEC1")
}
